...
TARGET_RECOVERY_INITRC := device/samsung/c1-spr/recovery.rc
TARGET_PROVIDES_MEDIASERVER := true

BOARD_MOBILEDATA_INTERFACE_NAME = "pdp0"

# Releasetools
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./device/samsung/c1-spr/releasetools/c1_ota_from_target_files
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./device/samsung/c1-spr/releasetools/c1_img_from_target_files
...
# Vibrator
BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/samsung/c1-spr/vibrator/tspdrv.c
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/c1-spr/shbootimg.mk

# assert
TARGET_OTA_ASSERT_DEVICE := SPH-D710

# Include aries specific stuff
-include device/samsung/c1-spr/Android.mk
