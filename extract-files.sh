...
adb pull /system/lib/hw/gps.s5pc210.so ../../../vendor/$MANUFACTURER/$COMMON/proprietary/hw/gps.SPH-D710.so
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/copybit.SPH-D710.so:system/lib/hw/copybit.s5pc210.so \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gps.SPH-D710.so:system/lib/hw/vendor-gps.s5pc210.so \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gralloc.default.so:system/lib/hw/gralloc.default.so \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gralloc.SPH-D710.so:system/lib/hw/gralloc.s5pc210.so
